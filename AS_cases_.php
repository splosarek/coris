...
?>
                ...
                <tr>
                    ...
                    <td title="<?= AS_CASES_CLREF_L ?>">
                        <div align="left">
                            <input type="text" name="client_ref" id="client_ref" size="20" maxlength="30" onchange="ClearSubmitSearch();"> 
          ...
          &nbsp;&nbsp;
            ...
            <input tabindex="12" type="text" name="paxDob_d" size="1" maxlength="2" onkeyup="move(this);" style="text-align: center"> 
                    ...
                    <td>
                        <div align="left">
                          <input tabindex="15" type="text" name="policy">
                        </div></td>
                </tr>
                <tr>
        ...
        <td width="70" align="right"><?= AS_CASES_MARKMOD ?> </td>
            ...
            <?= AS_CASES_NRREJ ?> 
            <input tabindex="4" type="text" name="nr_rej" size="15">
          </div></td>
                    <td width="70" align="right">
                        <small><?= COUNTRY ?></small>
                    </td>

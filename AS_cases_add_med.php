...
include('lib/lib_barclaycard.php');
include('lib/lib_chubb.php');
include('lib/lib_hansemerkur.php');
...
<html>
	...
	var 	lista_modulow = new Array('policy_agent','policy_agent2','policy_agent_cardif','policy_agent_europa','policy_agent_europa2','policy_agent_nhc','policy_agent_skok','policy_agent_allianz','policy_agent_vig_5','policy_agent_vig_7','policy_agent_vig_2306','policy_agent_vig_14500','policy_agent_ace','policy_agent_barclaycard','policy_agent_chubb','policy_agent_gother','policy_agent_hansemerkur');
	...
	function change_form(){
		...
		if (document.getElementById('contrahent_id').value == 7592) {
			...
			document.getElementById('policy_agent_barclaycard').style.display='none';
			document.getElementById('policy_agent_policy_agent_chubb').style.display='none';
			document.getElementById('policy_agent_gother').style.display='none';
		...
		}else if (document.getElementById('contrahent_id').value == 17241 ) { //Barclaycard
            hide_all();
            document.getElementById('country').value='DE';
            document.getElementById('branch_id').value=2;
            document.getElementById('policy_agent_barclaycard').style.display='inline';

            if ( document.getElementById('eventDate_d').value=="" ||  document.getElementById('eventDate_m').value=="" ||  document.getElementById('eventDate_y').value==""  ){
                console.log("17241 OK");
                 document.getElementById('eventDate_d').value="<?= date('d'); ?>";
                 document.getElementById('eventDate_m').value="<?= date('m'); ?>";
                 document.getElementById('eventDate_y').value="<?=  date('Y'); ?>";
            }else{
                console.log("17241 No");
            }

        }else if (document.getElementById('contrahent_id').value == 18371 ) { // Best Doctors Germany
            document.getElementById('branch_id').value=2;

        }else if (document.getElementById('contrahent_id').value == 17787 ) { //ChubbCase
            hide_all();
            //document.getElementById('country').value='DE';
            //document.getElementById('branch_id').value=2;
            document.getElementById('policy_agent_chubb').style.display='inline';

        }else if (document.getElementById('contrahent_id').value == 496 ) { //gother
            hide_all();
            //document.getElementById('country').value='DE';
            //document.getElementById('branch_id').value=2;
            document.getElementById('policy_agent_gother').style.display='inline';

        }else if (document.getElementById('contrahent_id').value == 18589 ) { //hansemerkur
            hide_all();

            document.getElementById('policy_agent_hansemerkur').style.display='inline';
            ...
            function validate() {
             ...
             /* if (form_reg.eventDate_d.value == "" || form_reg.eventDate_m.value == "" || form_reg.eventDate_y.value == "") {
              ...
              //  }
                ...
                if (document.getElementById('contrahent_id').value == 7592) {
                	...
                	if (document.getElementById('contrahent_id').value == 11086) { //cardif
						...
						if (document.getElementById('wariant_ubezpieczenia').value > 0 ) {
							...
							alert("Prosze wybrać wariant umowy");
                 ...
                 if (document.getElementById('contrahent_id').value == 11170) { //NHC
            		...
            		if ( document.getElementById('nhc_rezerwacurrency_id').value == '' ){
                				alert('Proszę podać walutę rezerwy!');
                ...
                if (document.getElementById('contrahent_id').value == 18589 ) { //hansemerkur
                    if (document.getElementById('hansemerkur_program').value == 0 ) {
                        alert("Prosze wybrać program");
                        document.getElementById('hansemerkur_program').focus();
                        return false;
                    }
                }
...
if (isset($_GET['action']) && !(isset($_SESSION['coris_case_submit']) && $_SESSION['coris_case_submit'] == "$_POST[paxName]#$_POST[paxSurname]")) {
    ...
    if ($result = mysql_query($query)) {
		...
		/////////////////////
            ...
            }  else  if (getValue('contrahent_id') == 17787){ //chubb
    					$case_id= $c_id;
                    //     ChubbCase::aktualizacja_programu($case_id, getValue('barclaycard_program'));

                        $_case = new ChubbCase($case_id);
                        $_case->setStatus(1);

                        $rezerwa = str_replace(',','.',getValue('chubb_rezerwa'));
                        $rezerwacurrency_id=getValue('chubb_rezerwacurrency_id');

                        $_case->aktualizujRezerweGlobalna($case_id,"0",$rezerwa,$rezerwacurrency_id);
            }else  if (getValue('contrahent_id') == 496){ //gother
    					$case_id= $c_id;
                    //     ChubbCase::aktualizacja_programu($case_id, getValue('barclaycard_program'));

                        $rezerwa = str_replace(',','.',getValue('gother_rezerwa'));
                        $rezerwacurrency_id=getValue('gother_rezerwacurrency_id');

                        CaseInfo::setGLobalReserveStart($case_id,$rezerwa,$rezerwacurrency_id);
            }else  if (getValue('contrahent_id') == 17241){ //barclaycard 17241
    					$case_id= $c_id;
                        BarclaycardCase::aktualizacja_programu($case_id, getValue('barclaycard_program'));

                        $barclaycard_case = new BarclaycardCase($case_id);
                        $barclaycard_case->setStatus(1);

                    $zid = intval(getValue('barclaycard_zgloszenie'));
                    if ($zid != "") {
                        $barclaycard_case->setZgloszenie($zid);
                    }


                    $rezerwa = str_replace(',','.',getValue('barclaycard_rezerwa'));
                    $rezerwacurrency_id=getValue('barclaycard_rezerwacurrency_id');

                    $barclaycard_case->aktualizujRezerweGlobalna($case_id,"0",$rezerwa,$rezerwacurrency_id);
            }else  if (getValue('contrahent_id') == 18589){ //hansemerkur
                        $case_id= $c_id;
                        $program=getValue('hansemerkur_program') > 0 ? getValue('hansemerkur_program') : 0;
                        HansemerkurCase::aktualizacja_programu($case_id, $program);
                    }
...
<?php
        ...
        if ($tryb == 'barcleycard'){
            ...
            $att_id = getValue('att_id');

            $id = Interaction::bindDocumentToCase($c_id,$doc_id,6,0,1);

         //   echo "Tryb barcleycard";


            $zgloszenie_id = getValue('barclaycard_zgloszenie');
            CorisCase::updateClientRef($c_id,"S".$zgloszenie_id);

           // echo "<br> updateClientRef $c_id  $zgloszenie_id";

            $departuredate = explode('/', getValue('barclaycard_departuredate'));
            $departuredate_ = $departuredate[2].'-'.$departuredate[1].'-'.$departuredate[0];

            CorisCase::updateDataWyjazdu($c_id,$departuredate_);
            //echo "<br> updateDataWyjazdu $c_id  $departuredate_";

            $_risks = getValue('barclaycard_risks');
            $risks = explode(',',$_risks);
            $r = 0;
            $tab = array (1 =>   11, //LKW RG
                2 =>   9, // LKW KL
                3 =>   12, //LKW BP
                4 =>   21, // LKW CDW
                5 =>   14 // LKW OC
            ...
            if ($r>0){
                CorisCase::updateTypeGenre($c_id,2,$r);

//                echo "<br> updateTypeGenre $c_id  $r";
            }



            $_email = getValue('barclaycard_email');
            if ($_email!= ''){
                CorisCase::updatePaxEmail($c_id,$_email);
            }

            echo '<script>opener.load_document(0);opener.load_documents();</script>';
...
<?php if(  $_SESSION['coris_branch'] == 1 ){ /* ?>
  <tr>
<td align="right"><div align="right"  > <small><b><?= AS_REZ_REZGLOB ?>:</b></small></small></div>
...
<?php */}?>
		...
		<td colspan="2">
          ...
          <table border="0" cellspacing=1 cellpadding=2  bgcolor="#d9d9d9" >
           <tr>
                <td width="100" align="right"><small>Ryzyko główne:</small></td>
                <td>
					<?php		echo  wysw_ryzyko_gl('ryzyko_gl',0,0,'class="required"'); ?>
                </td>
            </tr> <tr>
                <td width="100" align="right"><small>Rezerwa:</small></td>
                <td><small><b>Ryzyko cząstkowe: </b></small> <?php echo wysw_ryzyko_czastkowe('id_ryzyko',0,0,0,'class="required"') ?>&nbsp;&nbsp;&nbsp;<small><b>Rezerwa:</b></small>&nbsp;&nbsp;
        ...
        <table cellpadding="5" cellspacing="0" border="0"  width="680" >
			...
			<tr >
			 ...
			 <tr>
			 <td width="5%">&nbsp;</td>
                <td  align="right"><b>Ryzyko cząstkowe: </b></td>
                <td align="right"> <?php echo wysw_swiadczenie('id_swiadczenie',0,0,0,'class="required" onChange="getSumaUbezp(this.value,\'typ_umowy\',\'suma_ubezpieczenia\');"'); ?>&nbsp;&nbsp;&nbsp;<small><b>Rezerwa:</b></small>&nbsp;&nbsp;
				<input type="text" name="rezerwa_cardif" id="rezerwa_cardif" value=""  style="text-align: right;" size="15" maxlength="20" class="required">
				<?php  echo wysw_currency_pln('rezerwacurrency_id','PLN',0,'class="required"'); ?>

			<br>&nbsp;&nbsp;&nbsp;<small><b>Suma ubezpieczenia:</b></small>&nbsp;&nbsp;
        ...
        <table cellpadding="5" cellspacing="0" border="0"  width="680" >
            ...
            <span id="policy_agent_gother">
        <table cellpadding="5" cellspacing="0" border="0"  width="680" >
                <tr>	<td width="5%">&nbsp;</td>
                    <td align="right"  > <b>Rezerwa:</b></div></td><td>
				        <input type="text" name="gother_rezerwa" id="gother_rezerwa" value="100"  style="text-align: right;" size="15" maxlength="20" class="required">
                              <?php  echo wysw_currency_eur('gother_rezerwacurrency_id','EUR',0,'class="required"'); ?>

					</td></tr>
          </table>
        </span>
            <span id="policy_agent_chubb">
        <table cellpadding="5" cellspacing="0" border="0"  width="680" >
                <tr>	<td width="5%">&nbsp;</td>
                    <td align="right"  > <b>Rezerwa:</b></div></td><td>
				        <input type="text" name="chubb_rezerwa" id="chubb_rezerwa" value="500"  style="text-align: right;" size="15" maxlength="20" class="required">
                              <?php  echo wysw_currency_eur('chubb_rezerwacurrency_id','EUR',0,'class="required"'); ?>

					</td></tr>
          </table>
        </span>
            <span id="policy_agent_barclaycard">
                <input type="hidden" name="tryb" value="<?php echo getValue('tryb');?>">
                <input type="hidden" name="doc_id" value="<?php echo getValue('doc_id');?>">
                <input type="hidden" name="att_id" value="<?php echo getValue('att_id');?>">
                <input type="hidden" name="barclaycard_zgloszenie" value="">
                <input type="hidden" name="barclaycard_departuredate" value="">
                <input type="hidden" name="barclaycard_email" value="">

                <input type="hidden" name="barclaycard_risks" value="">
        <table cellpadding="5" cellspacing="0" border="0"  width="680" >

				<tr>	<td width="5%">&nbsp;</td>
					<td width="120" align="right"><b>Program:</b>	</td><td>
					<?php
					echo BarclaycardCase::wysw_wariant_umowy('barclaycard_program',0,0,'');
                ...
                <tr>	<td width="5%">&nbsp;</td>
                    <td align="right"  > <b>Rezerwa:</b></div></td><td>
				        <input type="text" name="barclaycard_rezerwa" id="barclaycard_rezerwa" value="700"  style="text-align: right;" size="15" maxlength="20" class="required">
                              <?php  echo wysw_currency_eur('barclaycard_rezerwacurrency_id','EUR',0,'class="required"'); ?>

					</td></tr>
          </table>
        </span>   <span id="policy_agent_hansemerkur">
        ...
        <table cellpadding="5" cellspacing="0" border="0"  width="680" >
				...
				<tr>	<td width="5%">&nbsp;</td>
					<td width="120" align="right"><b>Program:</b>	</td><td>
					<?php
					echo HansemerkurCase::wysw_wariant_umowy('hansemerkur_program',0,0,'class="required"');
...
-->
			 ...
			 <td width="5%">&nbsp;</td>
                ...
                <td ><div align="right"  style="margin-right:180px;"> <small><b>Rezerwa:</b></small>&nbsp;&nbsp;
...
?>
          ...
          <div id="policy_agent_allianz" ><span style="margin-left:250px">Trwa ładowanie... </span></div>
		...
		<td><a href="#menu" tabindex="-1"><img src="img/KwadN.gif" border="0"></a>&nbsp;<b><a name="szkoda"><font color="#6699cc"><?= AS_CASADD_SZK ?></font></a></b></td>
            ...
            <tr>
                ...
                <td>&nbsp;<input type="text" name="city" id="city" onchange="javascript:this.value=this.value.toUpperCase();" size="30" maxlength="30">
                </td>
            </tr>
            <tr>
...
?>
		...
		<td><a href="#menu" tabindex="-1"><img src="img/KwadN.gif" border="0"></a>&nbsp;<b><a name="szczegoly"><font color="#6699cc"><?= AS_CASADD_POSZKSZCZ ?></font></a></b></td>
            ...
            <tr>
                ...
                <td>
                    &nbsp;<input type="text" name="paxPhone" size="20" maxlength="30" style="text-align: center" onkeydown="remove_formant(this,event);">
                </td>
            </tr>
            <tr>
                <td width="100" align="right"><small><?= AS_CASADD_TELKOM ?></small><br><small>(yyyyyyyyy)</small></td>
                <td>
                    &nbsp;<input type="text" name="paxMobile" size="20" maxlength="30" style="text-align: center">
                </td>
            </tr>
        </table>
        <table cellspacing=1 cellpadding=2 width="100%" bgcolor="#d9d9d9">
    ...
    <?php
      $tryb = getValue('tryb');
        if ($tryb == 'barcleycard'){
                ...
                if ($att_id > 0 ) {
                    $doc = new Document($att_id);
                    $data_tmp = $doc->getBody();


                    $data = unserialize($data_tmp);
                    $register = $data['claim'];
                    $regid = $register['ID'];
                    ...
                    $eventdate = $register['eventdate'];//
                    $dateofdeparture = $register['dateofdeparture'];//
                    $eventcountry = $register['eventcountry'];//
                    $eventplace = $register['eventplace'];
                    $description = $register['description'];
                    $cardnumber = $register['cardnumber'];
                    $program = $register['program'];
                    $date = $register['date'];

                    $risks_tmp =$data['risks'];
                    $risks = array();
                    foreach ($risks_tmp As $item){
                        $risks[] = $item['ID'];
                    }

                    $js = '';
                    $js .= " JQ('input[name=paxSurname]').focus() \n\r" ;
                    $js .= " JQ('input[name=paxSurname]').val('".htmlspecialchars($surname)."') \n\r" ;
                    $js .= " JQ('input[name=paxName]').focus() \n\r" ;
                    $js .= " JQ('input[name=paxName]').val('".htmlspecialchars($name)."') \n\r" ;
                    $js .= " JQ('input[name=contrahent_id]').focus() \n\r" ;
                    $js .= " JQ('input[name=contrahent_id]').val('17241') \n\r" ;
                    $js .= " JQ('input[name=contrahent_id]').blur() \n\r" ;

                    if ($sex == 'Herr' ) {
                        $js .= " JQ('select[name=paxSex]').val('M') \n\r";
                    }else {
                        $js .= " JQ('select[name=paxSex]').val('K') \n\r";
                    }


                    $js .= " JQ('input[name=country]').focus() \n\r" ;
                    $js .= " JQ('input[name=country]').val('".$eventcountry."') \n\r" ;


                    $js .= " JQ('input[name=city]').focus() \n\r" ;
                    $js .= " JQ('input[name=city]').val('".$eventplace."') \n\r" ;

                    $birthday_tmp = explode('/',$birthday);
                    $js .= " JQ('input[name=paxDob_d]').val('".$birthday_tmp[0]."') \n\r" ;
                    $js .= " JQ('input[name=paxDob_m]').val('".$birthday_tmp[1]."') \n\r" ;
                    $js .= " JQ('input[name=paxDob_y]').val('".$birthday_tmp[2]."') \n\r" ;

                    $eventdate_tmp = explode('/',$eventdate);
                    $js .= " JQ('input[name=eventDate_d]').val('".$eventdate_tmp[0]."') \n\r" ;
                    $js .= " JQ('input[name=eventDate_m]').val('".$eventdate_tmp[1]."') \n\r" ;
                    $js .= " JQ('input[name=eventDate_y]').val('".$eventdate_tmp[2]."') \n\r" ;

                    $js .= " JQ('input[name=paxAddress]').val('".$address."') \n\r" ;
                  //  $js .= " JQ('input[name=paxAddress]').val('".$postcode."') \n\r" ;
                    $js .= " JQ('input[name=paxCity]').val('".$postcode.' '.$city."') \n\r" ;
                    $js .= " JQ('input[name=paxCountry]').focus() \n\r" ;
                    $js .= " JQ('input[name=paxCountry]').val('".$country."') \n\r" ;


                    $js .= " JQ('input[name=paxPhone]').val('".str_replace(' ','',trim($phone))."') \n\r" ;
                    $js .= " JQ('input[name=paxMobile]').val('".str_replace(' ','',trim($mobile))."') \n\r" ;

                    $js .= " JQ('input[name=policy]').val('".$cardnumber."') \n\r" ;
                    ...
                    $js .= " JQ('input[name=notificationDate_d]').val('".$date_tmp1[2]."') \n\r" ;
                    $js .= " JQ('input[name=notificationDate_m]').val('".$date_tmp1[1]."') \n\r" ;
                    $js .= " JQ('input[name=notificationDate_y]').val('".$date_tmp1[0]."') \n\r" ;
                    $js .= " JQ('input[name=notificationTime]').val('".$date_tmp[1]."') \n\r" ;


                    //$txt = 'Register date: '.$date;
                    //$txt .= '\nDeparture date: '.$dateofdeparture;
                    $txt .= $description;


                    $js .= " JQ('textarea[name=circumstances]').val('".$txt."') \n\r" ;
                    $js .= " JQ('input[name=barclaycard_zgloszenie]').val('".$regid."') \n\r" ;

                    $js .= " JQ('input[name=barclaycard_risks]').val('".implode(',',$risks)."') \n\r" ;
           //         $js .= " JQ('input[name=barclaycard_program]').val('".$program."') \n\r" ;
                    $js .= " JQ('input[name=barclaycard_departuredate]').val('".$dateofdeparture."') \n\r" ;
                    $js .= " JQ('input[name=barclaycard_email]').val('".$email."') \n\r" ;



                    $program_ = explode(',',$program);

                    $pr = 0;
                    if (count($program_) > 1 ){ // 3 +  4
                        $pr=10;
                    }else if (count($program_) == 1){
                        $tab_prze = array(1 => 2,2 =>  1, 3 =>  3,  4 =>  7, 5 => 8, 6 => 4, 7 => 6, 8 => 5, 9 => 9 );
                        $pr = $tab_prze[$program];
                    }
                    $js .= " JQ('select[name=barclaycard_program]').val('".$pr."') \n\r" ;
 ...
 * //jquery stuff
    ...
    [claim] => Array<br />
        (<br />
            ...
            [surname] => Kowalski<br />
            [5] => 01/02/2000<br />
            [birthday] => 01/02/2000<br />
            [6] => Zielona 13<br />
            [address] => Zielona 13<br />
            [7] => 00-000<br />
            [postcode] => 00-000<br />
            [8] => Warszawa<br />
            [city] => Warszawa<br />
            ...
            [11] => 324324324<br />
            [mobile] => 324324324<br />
            [12] => info@itmaks.pl<br />
            [email] => info@itmaks.pl<br />
            [13] => 31/01/2017<br />
            [eventdate] => 31/01/2017<br />
            [14] => 30/01/2017<br />
            [dateofdeparture] => 30/01/2017<br />
            [15] => DE<br />
            [eventcountry] => DE<br />
            [16] => warszawa2<br />
            [eventplace] => warszawa2<br />
            [17] => asdsadsadadasdsadsadsad<br />
            [description] => asdsadsadadasdsadsadsad<br />
            [18] => 123456789<br />
            [cardnumber] => 123456789<br />
            [19] => 127.0.0.1<br />
            [IP] => 127.0.0.1<br />
            [20] => 2017-02-03 11:15:58<br />
            [date] => 2017-02-03 11:15:58<br />
            [21] => c33650d0bbaf8b054f61a6abe7cb1a169c516ca7<br />
            [magickkey] => c33650d0bbaf8b054f61a6abe7cb1a169c516ca7<br />
        )<br />
<br />
    [risks] => Array<br />
        (<br />
            [0] => Array<br />
                (<br />
                    [ID] => 1<br />
                    [name] => ReiserĂźcktritt/Reiseabbruch / VerspĂ¤tete Abreise/Nichtantritt der Reise <br />
<br />
                )<br />
<br />
            [1] => Array<br />
                (<br />
                    [ID] => 3<br />
                    [name] => GepĂ¤ckverspĂ¤tung / PersĂśnliche Habe / Bargeld und andere Zahlungsmittel/ ReisepaĂ<br />
<br />
                )<br />
<br />
            [2] => Array<br />
                (<br />
                    [ID] => 4<br />
                    [name] => Mietwagen Teilkasko & Vollkasko <br />
<br />
                )<br />
<br />
            [3] => Array<br />
                (<br />
                    [ID] => 5<br />
                    [name] => Verkehrsmittelunfallversicherung/ Verkehrsmitthaftpflichtversicherung /Rechtskosten und Rechtsbeistand und andere Schadensfalle<br />
                )<br />
<br />
        )<br />
<br />

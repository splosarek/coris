...
include_once('lib/lib_allianz.php');
 ...
 if ($row['type'] == 3){ //akceptacja        
      ...
      $page_template->set('<!--KONTO_NAZWA-->' , 'Bank: ' );
     ...
     //  $file2 = html2pdf($body);
      ...
      $page_template->set('<!--KWOTA1-->' , print_currency($row['amount']) );
      $page_template->set('<!--KWOTA2-->' , print_currency($row['amount2']) );
      $page_template->set('<!--SUMA-->' , print_currency($row['payment_amount']) );

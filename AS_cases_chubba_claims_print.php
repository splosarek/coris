...
Chubb European Group Limited Sp. z o.o. Oddzia³ w Polsce, ul. Królewska 16 00-103 Warszawa, S±d Rejonowy dla m.st W-wy, XII Wydzia³ Gospodarczy Krajowego Rejestru S±dowego, NIP 1080001001, REGON 140121695, KRS 0000233686, notyfikowany Komisji Nadzoru Finansowego, dzia³aj±cy na podstawie zezwolenia udzielonego przez Prudential Regulation Authority, 20 Moorgate, Londyn EC2R 6DA Wielka Brytania, który to organ sprawuje równie¿ nadzór nad jego dzia³alno¶ci±. Wysoko¶æ kapita³u zak³adowego Chubb European Group Limited: 786.119.879 GBP.
');
  ...
  if ($id>0) {
      ...
      $query = "SELECT * FROM ".ChubbaCase::$TABLE_CLAIMS_DECISIONS."  WHERE ID='$id'";
...
<span style="font-size:8px;">S±d Rejonowy dla Wroc³awia Fabryczna we Wroc³awiu, KRS 0000002736, NIP 895-10-07-276, Kapita³ zak³adowy zarejestrowany i op³acony 31 500 000 z³</span>	
	...
	*/	
			$STOPKA_F =  '<div  style="margin: auto; width: 625px; text-align: left;margin-left:245px; margin-top: 10px;;border: #FFF solid 0px; font-size: 9px;font-family: Arial;">'.STOPKA_FIRM_N.'</div>';

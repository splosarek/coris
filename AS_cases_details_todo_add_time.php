...
<title><?PHP echo @CASEDETAILS ?></title>
<link href="Styles/general.css" rel="stylesheet" type="text/css">
 <style>
        ...
        <script language="JavaScript">
            ...
            function setTime(s) {
                ...
                if (tim1 && tim2 && tim3) {
                    opener.document.getElementById('due_time').value = document.getElementById('hour').value + ":" + document.getElementById('min10').value + document.getElementById('min1').value;
                    window.close();
                }
 ...
 <body>
        ...
        <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#d0d0d0">
            ...
            <tr align="center">
                <td>
                    <input type="text" name="hour" id="hour" size="1" style="width: 25px; text-align: center">
                </td>
                <td>
                    <font size="1">:</font>
                </td>
                <td>
                    <input type="text" name="min10" id="min10" size="1" style="width: 15px; text-align: center">
                </td>
                <td>
                    <input type="text" name="min1"  id="min1" size="1" style="width: 15px; text-align: center">
                </td>
            </tr>
            <tr>

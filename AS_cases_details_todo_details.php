...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $Result1 = mysql_query($updateSQL) or die(mysql_error());
	...
	$todo2users = mysql_query($query_todo2users) or die(mysql_error());
  ...
  $updateGoTo = "AS_cases_details_todo_details.php";
  if (isset($_SERVER['QUERY_STRING'])) {
    $updateGoTo .= (strpos($updateGoTo, '?')) ? "&" : "?";
    $updateGoTo .= $_SERVER['QUERY_STRING'];
  }
  
  //echo "<script>window.opener.parent.todoframe2.document.location = 'AS_cases_details_todo_frame2.php?case_id=$_POST[case_id]'; 
...
<table cellpadding=4 cellspacing=0 width="100%">
    <tr>
      <td colspan="2"><table width="100%">
          <tr valign="top">
            <td width="70%"><small><?= AS_CASD_ZAD ?></small><br>
            ...
            <td width="30%"><small><?= DUE ?></small><br>
                <table cellspacing="0" cellpadding="0" border="0">
                  <tr>
                    ...
                    <td align="center"><a href="javascript:void(0)" onclick="cal.select(document.form1.due_date,'anchor1','yyyy-MM-dd');" tabindex="-1" style="text-decoration: none" name="anchor1" id="anchor1"><img   src="img/kalendarz.gif" border="0"  ></a></td>
                  </tr>
                  <tr>
...
do {  
?>
        <option value="<?php echo $row_users['user_id']?>"<?php if ( $row_users['user_id']==$row_users['user_id_sel']) {echo "SELECTED";} ?>><?php echo $row_users['username']?></option>
        <?php

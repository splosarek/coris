...
include_once('lib/lib_voyage.php');
  ...
  if ($id>0) {
      ...
      $query = "SELECT * FROM coris_voyage_decisions  WHERE ID='$id'";
...
//      $page_template->set('<!--TEXT_1-->' , getTxt1($row['payment_amount']) );
     ...
     // 	$body .=  $page_template->realize();
      ...
      $page_template->load_template('../fax/templates/voyage_decyzje_operat_odmowa.html');
...
<span style="font-size:8px;">S±d Rejonowy dla Wroc³awia Fabryczna we Wroc³awiu, KRS 0000002736, NIP 895-10-07-276, Kapita³ zak³adowy zarejestrowany i op³acony 31 500 000 z³</span>	
		...
		*/
		$header = '';
		//$header = '<div  style="margin-right:0px; width: 920px; text-align: left; margin-top: 0px;border: #FFF solid 1px; "><img src="graphics/voyage_papie_firmowy_head2.jpg" /></div>';
		//$STOPKA_F = '<div  style="margin-right:0px; width: 920px; text-align: left; margin-top: 0px;border: #FFF solid 1px; "><img src="graphics/voyage_papie_firmowy_footer.png" style="margin-right:20px"/></div>';
		$STOPKA_F='';
	//	$watermark = '<img src="graphics/voyage_papie_firmowy.jpg">';
		$watermark= dirname(__FILE__).'/../fax/templates/paper/voyage_background3.pdf';

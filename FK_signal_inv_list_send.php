...
<tr><td>
  ...
  $query = "SELECT *  FROM coris_finances_invoices_in_forward_send  ORDER BY ID DESC ";   	
...
<tr bgcolor="#CCCCCC">
 ...
 <?php
  ...
  <tr bgcolor="<?PHP  echo ($i++ % 2) ? "#FFFFFF" : "#EEEEEE" ?>">
    <td nowrap><input type="button" value="&gt;" style="width: 20px" onClick="MM_openBrWindow('FK_signal_inv_send_print.php?payment_id=<?php echo $row['ID']; ?>','','scrollbars=yes,resizable=yes,width=760,height=800,left=20,top=20')"></td>

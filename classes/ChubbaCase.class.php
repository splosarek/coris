<?php
include('lib/Chubba/ChubbaClaim.php');
include('lib/Chubba/ChubbaClaimDetails.php');
include('lib/Chubba/ChubbaDecision.php');

/*include(dirname(__FILE__) . '../lib/Chubba/ChubbaClaim.php');
include(dirname(__FILE__) . '../lib/Chubba/ChubbaClaimDetails.php');
include(dirname(__FILE__) . '../lib/Chubba/ChubbaDecision.php');*/
